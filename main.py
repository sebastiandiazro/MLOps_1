...
#Crear una instancia de TfidfVectorizer con stopwords en ingles, lo hago una sola vez al inicio para mejorar el rendimiento
tfidf = TfidfVectorizer(stop_words='english')
    
#Crear la matriz tf-idf con los features de las peliculas
tfidf_matriz = tfidf.fit_transform(df_recomendacion['features'])

#Obtener el índice del título ingresado.
...
async def recomendacion_pelicula(titulo: str):
    ...
    if titulo not in indices:
        #Si no lo encuentra devuelver un error
